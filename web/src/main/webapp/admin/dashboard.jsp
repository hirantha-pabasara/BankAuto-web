                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <a href="pendingAccounts.jsp" class="btn btn-warning btn-block">
                                                <i class="fas fa-user-clock"></i> View Pending Accounts
                                            </a>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <a href="approveAccount.jsp" class="btn btn-success btn-block">
                                                <i class="fas fa-user-check"></i> Approve Accounts
                                            </a>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <a href="viewLogs.jsp" class="btn btn-info btn-block">
